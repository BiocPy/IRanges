...
Welcome to `IRanges` contributor's guide.
...
If you experience bugs or general issues with `IRanges`, please have a look
...
You can help improve `IRanges` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`IRanges` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `IRanges`'s files. While this mechanism can
...
```
conda create -n IRanges python=3 six virtualenv pytest pytest-cov
conda activate IRanges
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/IRanges.git
   cd IRanges
   ```
...
5. Install [pre-commit]:
   ...
   `IRanges` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/IRanges
[issue tracker]: https://github.com/<USERNAME>/IRanges/issues
